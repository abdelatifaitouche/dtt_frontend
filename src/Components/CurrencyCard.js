...
function CurrencyCard(props) {
  return (
    <div className='flex relative items-center justify-between p-6 w-56 bg-white rounded-2xl shadow'>
        ...
        <div>
            <p className='text-md font-bold text-gray-500 lg:text-md dark:text-gray-400'>{props.currency}</p>
                <hr></hr>
            <p className='font-extrabold text-xl text-black'>{props.currencyData}</p>
        </div>
    </div>
  )
}
